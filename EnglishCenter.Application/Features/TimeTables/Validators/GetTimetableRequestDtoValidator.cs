...
namespace EnglishCenter.Application.Features.Timetables.Validators;

public class GetTimetableRequestDtoValidator : AbstractValidator<GetTimetableRequestDto>
{
    private static readonly string[] AllowedSortBy =
    [
        "SessionDate", "StartTime", "EndTime", "SessionNo", "Status", "CreatedAt"
    ];

    public GetTimetableRequestDtoValidator()
    {
